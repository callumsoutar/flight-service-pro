...
export default function InvoicesTable({ statusFilter }: { statusFilter: string }) {
  ...
  if (invoices.length === 0) {
    return <div className="p-6 text-center text-muted-foreground">No invoices found.</div>;
  }
