...
import { Info, Repeat, Calendar, Settings2, StickyNote, ArrowUpRight, Loader2, CalendarIcon, ChevronDown, ChevronUp } from "lucide-react";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[700px] max-w-[98vw] mx-auto p-6 bg-white rounded-2xl shadow-xl border border-muted overflow-y-auto max-h-[90vh]">
        <DialogHeader className="mb-3">
          ...
          <DialogDescription className="text-sm text-muted-foreground font-normal">Update all details for this aircraft component.</DialogDescription>
        </DialogHeader>
        <form className="flex flex-col gap-5 w-full" onSubmit={handleSave}>
            ...
            <div className="bg-gray-50 rounded-lg p-3 flex flex-col gap-3">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                ...
                {component && component.extension_limit_hours !== null && (
                  ...
                  >
                    {revertLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : <ArrowUpRight className="w-4 h-4 rotate-180" />}
              ...
              {showRevertConfirm && (
                <div className="p-3 bg-red-50 border border-red-200 rounded-lg flex flex-col gap-2">
                  <div className="text-xs text-red-700 font-medium">Are you sure you want to revert the extension? This will remove the current extension limit and restore the original due logic.</div>
          ...
          <DialogFooter className="pt-4 flex flex-col sm:flex-row gap-2 sm:gap-3 w-full">
            ...
            <Button type="submit" className="w-full sm:w-auto bg-indigo-600 hover:bg-indigo-700 text-white font-semibold" disabled={!component}>Save Changes</Button>
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
