      ...
      <div className="overflow-x-auto rounded-lg border border-muted bg-white">
        <table className="min-w-full text-sm">
          <thead className="bg-muted/60">
            <tr>
              <th className="px-4 py-3 text-left font-semibold text-base w-56">Component Name</th>
            ...
            {loading ? (
              ...
              components.map((comp) => {
                ...
                return (
                  ...
                  >
                    <td className="px-4 py-3 text-left font-semibold align-middle w-56 whitespace-nowrap">{comp.name}</td>
                    ...
                    <td className="px-4 py-3 text-center font-semibold align-middle w-40">{dueIn}</td>
