...
export default function SyllabusConfig() {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm("Are you sure you want to void this syllabus? This will hide it from the list but preserve the data.")) {
      return;
    }
  ...
  return (
    <div>
        ...
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-medium">Training Syllabi</h3>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="e.g., PPL Ground School, CPL Training"
                  />
                </div>
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Enter a description for this syllabus"
                    rows={3}
                  />
                </div>
                <div>
                  <Label htmlFor="number_of_exams">Number of Exams</Label>
                  <Input
                    id="number_of_exams"
                    type="number"
                    min="0"
        ...
        {syllabi.length === 0 ? (
          <div className="text-center py-8 text-gray-500">
            No syllabi configured yet. Click &quot;Add Syllabus&quot; to get started.
          </div>
        ) : (
          <Table>
            <TableHeader>
            ...
            <TableBody>
              {syllabi.map((syllabus) => (
                <TableRow key={syllabus.id}>
                  ...
                  <TableCell>{syllabus.number_of_exams}</TableCell>
                  <TableCell>
                    <span
        ...
        <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
          <DialogContent className="max-w-md w-full rounded-xl p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="edit-number_of_exams">Number of Exams</Label>
                <Input
