...
export default function CreateMembershipModal({
  ...
  const expiryDate = useCustomExpiry && customExpiryDate 
    ? customExpiryDate 
      ...
      <DialogContent className="w-[675px] h-[700px] max-w-[90vw] max-h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader className="space-y-2 pb-4">
          ...
          <p className="text-gray-600 text-sm">
            Set up a new membership for this member
          </p>
        </DialogHeader>
                ...
                <div className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-lg">
                  {selectedType ? (
                    <>
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1">
                          ...
                          {selectedType.description && (
                            <p className="text-sm text-gray-600 mb-2">{selectedType.description}</p>
                          )}
                      ...
                      {selectedType.benefits && selectedType.benefits.length > 0 && (
                        <div className="pt-3 border-t border-blue-200">
                          <h5 className="text-sm font-medium text-blue-900 mb-2">Membership Benefits</h5>
                    ...
                    <div className="flex flex-col items-center justify-center h-full text-center">
                      ...
                      <h4 className="font-medium text-gray-900 mb-1">Select a Membership Type</h4>
                      <p className="text-sm text-gray-600">Choose a membership type above to see details and benefits</p>
                    </div>
                  )}
                </div>
              </>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2 p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <label htmlFor="use-custom-expiry" className="text-sm font-medium cursor-pointer">
                        Custom expiry date
                      </label>
                      <p className="text-xs text-gray-600">
